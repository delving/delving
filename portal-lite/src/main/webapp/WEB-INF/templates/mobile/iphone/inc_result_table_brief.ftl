...
<#list seq as cell>
<li class="withimage" >
	<a id="${cell.type}_gradientitem" href="full-doc.html?${queryStringForPresentation}&amp;tab=${tab}&amp;start=${cell.index?c}&amp;startPage=${pagination.start?c}&amp;uri=${cell.id}&amp;view=${view}&amp;pageId=bd">
...
<#list seq as cell> 
 <li class="textonly">
	<a id="${cell.type}item" href="full-doc.html?${queryStringForPresentation}&amp;tab=${tab}&amp;start=${cell.index?c}&amp;startPage=${pagination.start?c}&amp;uri=${cell.id}&amp;view=${view}&amp;pageId=bd">
...
<#macro show_result_flow seq>
 <div id="imagelist">
   <#list seq as briefDoc>
		<a class="imageresult" id="${briefDoc.type}item" href="full-doc.html?${queryStringForPresentation}&amp;tab=${tab}&amp;start=${briefDoc.index?c}&amp;startPage=${pagination.start?c}&amp;uri=${briefDoc.id}&amp;view=${view}&amp;pageId=bd">  
			<#if useCache="true">
