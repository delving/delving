            ...
            <#elseif pageId == "fd">
    			...
    			<#-- on the full doc, we provide a link back to the result page with the appropriate icon -->
           		<#if pagination?? && pagination.returnToResults?? && view?? && query?? && query?length &gt; 0 >
           		    ...
           		    <#switch view>
    					<#case "text_only"><img class="titleresultnav" src="mobile/images/text_only.gif" /><#break/>
    					<#case "image_only"><img class="titleresultnav" src="mobile/images/image_only.gif" /><#break/>
    					<#default><#case "mixed"><img class="titleresultnav" src="mobile/images/mixed.gif" /><#break/>
      				</#switch>           		                  
                    </a>
                </#if>
