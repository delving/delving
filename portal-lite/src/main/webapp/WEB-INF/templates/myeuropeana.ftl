    ...
    <div id="savedItems">
        <ul>
            ...
            <li><a href="#fragment-1"
                   ...
                   onclick="$.cookie('ui-tabs-3', '1', { expires: 1 });"><span><@spring.message 'SavedItems_t'/></span></a></li>
            ...
            <li><a href="#fragment-3"
                   ...
                   onclick="$.cookie('ui-tabs-3', '3', { expires: 1 });"><span><@spring.message 'SavedTags_t'/></span></a></li>
        </ul>
        <div id="fragment-0">
                                ...
                                <a href="full-doc.html?uri=${item.europeanaId.europeanaUri}">
                                    <#if useCache="true">
                                        <img class="thumb" align="middle"
                                             ...
                                             onerror="showDefaultSmall(this,'${item.docType}')"/>
                                    <#--<#else>-->
                                    <#--<#if item.docType??>-->
                            ...
                            <tr>
                                <td width="35" align="right">
                                    <#if tag.europeanaObject??>
                                        <#if useCache = "true">
                                            <img class="thumb"
                                                 src="${cacheUrl}uri=${tag.europeanaObject}&size=BRIEF_DOC"
                                                 alt="Click for more information" width="25"/>
                                        </#if>
                                    </#if>
                                </td>
                                <td valign="top" class="item-info">
