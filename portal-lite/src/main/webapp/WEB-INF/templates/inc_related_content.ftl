        <h5><@spring.message 'RelatedContent_t' />:</h5>
            ...
            <#if user??>
                ...
                <p class="linetop">
                    <a href="#" onclick="saveItem('${postTitle?js_string}','${postAuthor?js_string}','${result.fullDoc.id?js_string}','${result.fullDoc.thumbnail[0]?js_string}','${result.fullDoc.europeanaType}');"><@spring.message 'SaveToMyEuropeana_t' /></a>
