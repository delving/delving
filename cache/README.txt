...
EuropeanaLabs Cache Module Read Me file
------------------------------------------------------


The Europeana Cache Module contains the code for retrieving and caching
thumbnails which is shared amongst various EuropeanaLabs modules. This
