# README for the Delving Platform #
...
First read the documentation in the docs directory and on the [wiki](http://wiki.github.com/kiivihal/delving/). If you still have questions you can subscribe to the Delving-dedicated mailing list: [http://groups.google.com/group/delving-community][delving-mailinglist].
