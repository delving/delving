...
<div id="main" class="grid_9">
    ...
    <div id="savedItems">
        <ul>
            <li>
                <a href="myeuropeana.ftl#fragment-0" title="<@spring.message 'UserInformation_t' />"><span><@spring.message 'UserInformation_t' /></span></a>
            </li>
            <li>
                <a href="myeuropeana.ftl#fragment-1" title="<@spring.message 'SavedItems_t'/>"><span><@spring.message 'SavedItems_t'/></span></a>
            </li>
            <li>
                <a href="myeuropeana.ftl#fragment-2" title="<@spring.message 'SavedSearches_t'/>"><span><@spring.message 'SavedSearches_t'/></span></a>
            </li>
            <li>
                <a href="myeuropeana.ftl#fragment-3" title="<@spring.message 'SavedTags_t'/>"><span><@spring.message 'SavedTags_t'/></span></a>
            </li>
        </ul>
        <div id="fragment-0">
                ...
                <#if user.savedItems?size &gt; 0>
                    <#list user.savedItems as item>
                        <tr>
                            ...
                            <td width="60">
                                <button onclick="removeRequest('SavedItem',${item.id?string("0")});"><@spring.message 'Delete_t'/></button>
                            </td>
                        </tr>
                    </#list>
            ...
            <table width="100%" class="tbl-list" summary="list with saved searches">
                <#if user.savedSearches?size &gt; 0>
                    <#list user.savedSearches as search>
                        <tr>
                            <td valign="top" class="item-info">
                                <a href="/${portalName}/brief-doc.html?${search.query}&bt=savedSearch">${search.queryString}</a>

                                <p><@spring.message 'DateSaved_t'/>: <em>${search.dateSaved?datetime}</em></p>
                            </td>
                            <td width="60">
                                <button onclick="removeRequest('SavedSearch',${search.id?string("0")});"><@spring.message 'Delete_t'/></button>
                            </td>
                        </tr>
                    </#list>
                    <#else>
                    ...
                    <#list user.socialTagLists as count>
                        ...
                        <#list count.list as tag>
                            <tr>
                                ...
                                <td width="60">
                                    <button onclick="removeRequest('SocialTag',${tag.id?string("0")});"><@spring.message 'Delete_t'/></button>
                                </td>
                            </tr>
                        </#list>
