...
<div id="main" class="grid_9">
               ...
               <div id="savedItems">
                    <ul>
                        <li><a href="myeuropeana.ftl#fragment-0" title="<@spring.message 'UserInformation_t' />"><span><@spring.message 'UserInformation_t' /></span></a></li>
                        <li><a href="myeuropeana.ftl#fragment-1" title="<@spring.message 'SavedItems_t'/>"><span><@spring.message 'SavedItems_t'/></span></a></li>
                        <li><a href="myeuropeana.ftl#fragment-2" title="<@spring.message 'SavedSearches_t'/>"><span><@spring.message 'SavedSearches_t'/></span></a></li>
                        <li><a href="myeuropeana.ftl#fragment-3" title="<@spring.message 'SavedTags_t'/>"><span><@spring.message 'SavedTags_t'/></span></a></li>
                    </ul>
                   <div id="fragment-0">
