    ...
    <div id="savedItems">
       ...
       <div id="tab-0">
          <table summary="table with user information" id="tbl-user" >
            ...
            <tr>
                <td width="150">
                    <h6><@spring.message '_mine.username' />:</h6>
                </td>
                <td>${user.userName}</td>
            </tr>
            <tr>
              <td><h6><@spring.message '_mine.email.address'/>:</h6></td>
              <td>${user.email}</td>
            </tr>
            <#if user.firstName??>
            <tr>
              <td><h6><@spring.message '_mine.firstname'/>:</h6></td>
              <td>${user.firstName}</td>
            </tr>
            </#if>
            <#if user.lastName??>
            <tr>
              <td><h6><@spring.message '_mine.last.name'/>:</h6></td>
              <td>${user.lastName}</td>
            </tr>
            </#if>
            <#if user.registrationDate??>
            <tr>
              <td><h6><@spring.message '_mine.user.registration.date'/>:</h6></td>
              <td>${user.registrationDate}</td>
            </tr>
            </#if>
            <#if user.lastLogin??>
            <tr>
              <td><h6><@spring.message '_mine.user.last.login.date'/>:</h6></td>
