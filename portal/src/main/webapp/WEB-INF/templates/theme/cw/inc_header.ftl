...
<#macro localeBased type toSwitch>
    ...
    <#else>
        <img src="/${portalName}/${portalTheme}/images/${toSwitch?replace('$$',locale)!'think_culture_en_small.gif'}" alt=""/>
    </#if>
</#macro>
...
<head>
    ...
    <script type="text/javascript" src="/${portalName}/${portalTheme}/js/jquery-ui-1.8.custom.min.js"></script>
