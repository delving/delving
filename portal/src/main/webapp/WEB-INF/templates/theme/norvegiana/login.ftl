...
<fieldset>
    ...
    <table>
        ...
        <tr>
            ...
            <td align="right">
                <input name="submit_login" class="button" type="submit" value="<@spring.message '_mine.login' />"/>
                <br/><br/><a href="/${portalName}/forgot-password.html"><@spring.message '_mine.forgotpassword' /></a>
            </td>
        </tr>
    </table>
