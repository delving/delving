...
// These templates will be displayed as a dropdown in all media dialog if the "template_external_list_url"
// option is defined in TinyMCE init.

// 'baseThemePath' is set in js_utilities.js
var tinyMCETemplateList = [
	// Name, URL, Description
	["Informatie \"box\" 1", baseThemePath+"/snippets/info-block.template", "Information box with header and background color"]
    ,["Menu List", baseThemePath+"/portal/theme/basic/snippets/menu-list.template", "Menu list with title and items"]
