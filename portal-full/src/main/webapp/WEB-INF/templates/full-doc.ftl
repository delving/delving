                ...
                <div style="width:200px; max-height: 400px; overflow-x:hidden; overflow-y:hidden; scrolling: none;  text-align:center; ">
                    ...
                    <#elseif !result.fullDoc.europeanaIsShownAt[0]?matches(" ")>
                       ...
                       <a href="redirect.html?shownBy=${imageRef?url('utf-8')}&provider=${result.fullDoc.europeanaProvider[0]}&id=${result.fullDoc.id}" target="_blank">
                        ...
                        <img src="${result.fullDoc.thumbnail[0]}" alt="Image title: ${result.fullDoc.dcTitle[0]}" id="imgview" onload="checkSize(this.height);" onerror="showDefault(this,'${result.fullDoc.europeanaType}')"/>
                        </#if>
                    </a>
...
<h3><@spring.message 'RelatedContent_t' />:</h3>
    ...
    <div class="toggler-c" title="<@spring.message 'AddATag_t' />">
        <#--<div id="ysearchautocomplete">-->
              <form action="#" method="post" onsubmit="addTag(document.getElementById('tag').value,'${result.fullDoc.id}','${result.fullDoc.thumbnail[0]}','${postTitle}','${result.fullDoc.europeanaType}'); return false;"  id="form-addtag" name="form-addtag" accept-charset="UTF-8">
    ...
    <div class="related-links">
        <p class="linetop">
            <a id="saveToMyEuropeana" href="#" onclick="saveItem('${postTitle?js_string}','${postAuthor?js_string}','${result.fullDoc.id?js_string}','${result.fullDoc.thumbnail[0]?js_string}','${result.fullDoc.europeanaType}');"><@spring.message 'SaveToMyEuropeana_t' /></a>
