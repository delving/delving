                                    ...
                                    <tr>
                                        ...
                                        <td width="220" align="right">
                                            ...
                                            <#if user?? && !item.europeanaId.orphan>
                                                ...
                                                <#--        <input type="checkbox" class="carousel-input" id="carousel_${item.id?string("0")}"
                                                                ${item.enabled()}  ${item.checked()}
                                                               onclick="carouselRequest('CarouselItem',${item.id?string("0")});">carousel</input>-->
                                                </#if>
                                            </#if>
                                        </td>
                                    </tr>
                                    ...
                                    <td width="230" align="right">
                                       <button class="del-button"
                                        ...
                                        <#if user?? >
                                            ...
                                            <#--<input type="checkbox" class="pacta-input" id="pacta_${search.id?string("0")}"
                                                                ${search.enabled()}  ${search.checked()}
                                                                 onclick="pactaRequest('EditorPick',${search.id?string("0")});">pacta</input>-->
                                            </#if>
                                        </#if>
                                        </td>
                                </tr>
