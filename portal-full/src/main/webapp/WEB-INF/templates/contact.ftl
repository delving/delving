        ...
        <div  class="yui-b">
            <div  class="yui-g">
                <div  class="yui-g first">
                    ...
                    <p>
                    See the <a href="http://version1.europeana.eu/web/guest/provide_content" onclick="">content providers</a> page on our project site <br/>
                    </p>
                        ...
                        <fieldset>
                           ...
                           <p>
                            ...
                            <@spring.bind "command.email" />
                               <#-- Unclear why errorMessages cannot be called from here. errorCode comes through.
                                This fix should be removed when it is clear why
                                -->
                           <#--list spring.status.errorMessages as error><span class="fg-red"> <i>${error}</i></span> <br/> </#list>-->
                               <#list spring.status.errorCodes as code>
                                    <span class="fg-red"><i><#switch code>
                            ...
                            <@spring.bind "command.email" />
                                ...
                                <#if  spring.status.error><span class="fg-red"><i>Please enter some feedback text.</i></span></#if>
                             </p>
