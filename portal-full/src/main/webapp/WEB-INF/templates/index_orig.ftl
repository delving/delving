                            ...
                            <#list carouselItems as carouselItem>
                                ...
                                <li class="category_${doc.type}">
                                    <a href="full-doc.html?uri=${doc.id}">
                                        ...
                                        <#if useCache="true">
                                            <img src="${cacheUrl}uri=${doc.thumbnail?url('utf-8')}&size=BRIEF_DOC&type=${doc.type}"  onerror="showDefault(this,'${doc.type}')" style="z-index:99" width="70" alt="<@stringLimiter '${title?html}' '50'/>" title="<@stringLimiter '${title?html}' '50'/>"/>
                                        <#else>
                                            <img src="${doc.thumbnail}" onerror="showDefault(this,'${doc.type}')" width="70" alt="<@stringLimiter "${title?html}" "50"/>" title="<@stringLimiter "${title?html}" "50"/>"/>
                                        </#if>
                                    </a>
                                </li>
                            </#list>
